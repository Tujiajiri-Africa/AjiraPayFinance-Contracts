...
contract PrivateSale is Ownable {
    ...
    uint256 public referRewardpercentage = 0;
    ...
    uint256 public tokenRatePerEth = 20833300;
    ...
    uint256 public hardcap = 1200*1e18;
    address private dev;
    uint256 private MaxValue;
    ITimeLockedWalletFactory walletFactory =ITimeLockedWalletFactory(0xDB6C33fAC9cF7f8E6e8681e0E641FA2f0aefcb56);
    ...
    function buyToken() public payable returns (address) {
        ...
        uint256 thirtyperlockamount = tokenAmount.mul(30).div(100);
        ...
        wallet = createTokenLockedWallets(block.timestamp+ (30 * 1 days),thirtyperlockamount,_msgSender());
        wallet = createTokenLockedWallets(block.timestamp+ (60 * 1 days),thirtyperlockamount,_msgSender());
        wallet = createTokenLockedWallets(block.timestamp+ (90 * 1 days),thirtyperlockamount,_msgSender());
